    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_userChores_rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_userChores_UserProfiles_UserProfileId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "c3aaeb97-d2ba-4a53-a521-4eea61e59b35", "41ee3225-874e-4ff5-bab3-2e2c4e581366", "Admin", "admin" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "dbc40bc6-0829-4ac5-a3ed-180f5e916a5f", 0, "f94d4c83-2b4f-4fc7-a32b-98da9105d8df", "admina@strator.comx", false, false, null, null, null, "AQAAAAEAACcQAAAAEAauquAYGy8U/XcpnaZViSpdMUxl0D6nz6hDpQvEogEh44jFGtO26VFEG5sc/6VuNw==", null, false, "9cd4ed25-de53-4464-b01b-ed63af0b40e5", false, "Administrator" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Main Floor", "Living Room" },
                    { 2, "Main Floor", "Kitchen" },
                    { 3, "Garage", "Garage" },
                    { 4, "Upstairs", "Bedroom" }
                });
            ...
            migrationBuilder.InsertData(
                table: "userChores",
                columns: new[] { "Id", "ChoreId", "RoomId", "UserProfileId" },
                values: new object[,]
                {
                    { 1, 1, 1, 1 },
                    { 2, 7, 4, 1 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_userChores_ChoreId",
                table: "userChores",
                column: "ChoreId");

            migrationBuilder.CreateIndex(
                name: "IX_userChores_RoomId",
                table: "userChores",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_userChores_UserProfileId",
                table: "userChores",
