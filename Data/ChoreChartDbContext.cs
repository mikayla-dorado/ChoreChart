...
public class ChoreChartDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Chore>().HasData(new Chore[]
        {
            ...
            new Chore {Id = 2, Name = "Sweep", Description = "Sweep all floors", DueDate = new DateTime(2024, 1, 19), Status = "Completed", Comment = null},
            new Chore {Id = 3, Name = "Clean Counters", Description = "Wipe down all kitchen counters", DueDate = new DateTime(2024, 1, 24), Status = "Pending", Comment = null},
            new Chore {Id = 4, Name = "Mop", Description = "Mop all floors after sweeping", DueDate = new DateTime(2024, 1, 19), Status = "Completed", Comment = null},
            new Chore {Id = 5, Name = "Do Dishes", Description = "Wash all Dishes", DueDate = new DateTime(2024, 1, 26), Status = "In Progress", Comment = null},
